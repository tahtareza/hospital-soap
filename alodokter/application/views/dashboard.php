...
<div class="super_container">
	...
	<div class="menu trans_500">
		<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
			...
			<ul>
				...
				<!-- <li class="menu_item"><a href="<echo base_url('C_rumahsakit'); ?>">Rumah Sakit</a></li> -->
	...
	<div class="home">
		<div class="background_image" style="background-image:url(<?php echo base_url(); ?>assets/images/index_hero.jpg)"></div>
								...
								<div class="row">
									<div class="col">
										<div class="header_nav_content d-flex flex-row align-items-center justify-content-start">
											<nav class="main_nav">
												<ul class="d-flex flex-row align-items-center justify-content-start">
													<li class="active"><a href="<?php echo base_url('C_dashboard'); ?>">Home</a></li>
													...
													<!-- <li><a href="<echo base_url('C_rumahsakit'); ?>">Rumah Sakit</a></li> -->
													<li><a href="<?php echo base_url('C_rumahsakit1'); ?>">Rumah Sakit</a></li>
				...
				<div class="row">
					<div class="col">
						<div class="home_content">
							...
							<div class="home_text">Mangga Berobat</div>
						...
						<div class="dept_slider_container">
							...
							<div class="owl-carousel owl-theme dept_slider">
								...
								<div class="owl-item dept_item">
									<div class="dept_image"><img src="<?php echo base_url(); ?>assets/images/dept_1.jpg" alt=""></div>
								...
								<!-- Slide -->
								<div class="owl-item dept_item">
									<div class="dept_image"><img src="<?php echo base_url(); ?>assets/images/dept_2.jpg" alt=""></div>
									<div class="dept_content">
								...
								<!-- Slide -->
								<div class="owl-item dept_item">
									<div class="dept_image"><img src="<?php echo base_url(); ?>assets/images/dept_3.jpg" alt=""></div>
									<div class="dept_content">
								...
								<!-- Slide -->
								<div class="owl-item dept_item">
									<div class="dept_image"><img src="<?php echo base_url(); ?>assets/images/dept_4.jpg" alt=""></div>
									<div class="dept_content">
						...
						<div class="news_container">
							...
							<div class="latest d-flex flex-row align-items-start justify-content-start">
								...
								<div class="latest_content">
									<div class="latest_title"><a href="<?php echo base_url('C_news'); ?>">A simple blog post</a></div>
							...
							<div class="latest d-flex flex-row align-items-start justify-content-start">
								...
								<div class="latest_content">
									<div class="latest_title"><a href="<?php echo base_url('C_news'); ?>">A new way to see things in medicine</a></div>
									<div class="latest_info">
										<ul class="d-flex flex-row align-items-start justify-content-start">
											<li><a href="#">by Jane Smith</a></li>
											<li><a href="#">April 25, 2018</a></li>
							...
							<div class="latest d-flex flex-row align-items-start justify-content-start">
								...
								<div class="latest_content">
									<div class="latest_title"><a href="<?php echo base_url('C_news'); ?>">Why is Pharma industry so big?</a></div>
									<div class="latest_info">
										<ul class="d-flex flex-row align-items-start justify-content-start">
											<li><a href="#">by Jane Smith</a></li>
											<li><a href="#">April 25, 2018</a></li>
